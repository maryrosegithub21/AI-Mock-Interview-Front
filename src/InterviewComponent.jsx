...
//       // Setup of user's response in the text area
//       setUserResponse('');
//     } catch (error) {
//       if (error.response) {
//         // Server responded with a status other than 200 range
...
//   return (
//     <div>
//       <input type="text" value={userResponse} onChange={handleUserResponseChange} />
//       <input type="text" value={role} onChange={handleRoleChange} />
//       <button onClick={handleSubmit}>Submit</button>
//       <div>
//         {conversation.map((entry, index) => (
//           <div key={index}>
//             <strong>{entry.role}:</strong> {entry.parts[0].text}
//           </div>
//         ))}
//       </div>
//     </div>
